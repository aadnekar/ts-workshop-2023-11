import type { Expect, Equal, Compute } from '../common';
 ...
 */
namespace first {
  type First<Tuple extends any[]> = Tuple extends [infer First, ...any] ? First : undefined;

  type res1 = First<[]>;
  type test1 = Expect<Equal<Compute<res1>, undefined>>;
